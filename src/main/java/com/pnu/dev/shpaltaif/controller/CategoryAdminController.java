...
public class CategoryAdminController {
    ...
    @PostMapping("/new")
    public String create(CategoryDto categoryDto, RedirectAttributes redirectAttributes) {
    ...
    public String update(@PathVariable("id") Long id, CategoryDto categoryDto, RedirectAttributes redirectAttributes) {
